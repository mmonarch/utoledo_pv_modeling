...
import r1_utils as r1

from pv_analysis import total_energy
from pv_io import load_date
from pv_model import run_models
from weather import get_clear_sky

import datetime as dt
import matplotlib.pyplot as plt

def clear_sky_irradiance(data):
    times = r1_data.index.tz_localize('EST')
